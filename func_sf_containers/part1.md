...
With Azure Functions v2 and .NET Core it is possible to have images reduced in size and host those on Linux: [Azure Functions inside Containers hosted in Service Fabric - Part 2 (WebHost v2)](./
part2.md)